// https://registry.terraform.io/providers/vancluever/acme/2.28.2/docs
...
export class AcmeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AcmeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/vancluever/acme/2.28.2/docs#import import section} in the documentation of this resource for the id to use

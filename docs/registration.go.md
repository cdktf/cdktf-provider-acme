...
```go
import "github.com/cdktf/cdktf-provider-acme-go/acme/v7/registration"
...
&registration.RegistrationConfig {
	...
	EmailAddress: *string,
	ExternalAccountBinding: github.com/cdktf/cdktf-provider-acme-go/acme/v7.registration.RegistrationExternalAccountBinding,
	Id: *string,
}
```
